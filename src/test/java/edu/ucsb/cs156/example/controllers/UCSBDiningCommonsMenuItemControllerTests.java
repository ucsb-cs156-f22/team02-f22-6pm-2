...
public class UCSBDiningCommonsMenuItemControllerTests extends ControllerTestCase {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                UCSBDiningCommonsMenuItem ucsbMenuItem = UCSBDiningCommonsMenuItem.builder()
                                .diningCommonsCode("test_code")
                                .name("burger")
                                .station("carillo")
                                .build();

                when(ucsbDiningCommonsMenuItemRepository.findById(eq(7L))).thenReturn(Optional.of(ucsbMenuItem));
        ...
        public void an_admin_user_can_post_a_new_ucsbmenuitem() throws Exception {
                ...
                UCSBDiningCommonsMenuItem ucsbMenuItem1 = UCSBDiningCommonsMenuItem.builder()
                                .diningCommonsCode("menu_item_code1")
                                .name("chowder")
                                .station("carillo")
                                .build();
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/UCSBDiningCommonsMenuItem/post?diningCommonsCode=menu_item_code1&name=chowder&station=carillo")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
